...
class PagoDocenteController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'horas_teoricas' => 'nullable|numeric|min:0',
            'horas_practicas' => 'nullable|numeric|min:0',
            'costo_hora_teorica' => 'nullable|numeric|min:0',
            'costo_hora_practica' => 'nullable|numeric|min:0',
